 ...
 */
@Controller
@RequestMapping("/sr/scanin")
public class AdpScanInController extends BaseController {

    final static String MENU = "SAMPLE_ROOM";
    final static String PRIVILEDGE = "SCAN_IN";
    private String BASE_VIEW = "03.sample/";
    private String LIST_VIEW = "adpscanin";
    ...
    AjaxResponse save(@RequestBody JdcAdpTxnbarcode model, HttpSession session) throws Exception {
        ...
        if (data != null) {
            return new AjaxResponse(false, "Data Already exist !");
        }
