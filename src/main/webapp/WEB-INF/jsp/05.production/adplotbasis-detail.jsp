                ...
                var oTable = $("#dataTable").dataTable({
                    ...
                    "aoColumnDefs": [
                        ...
                        
                        {
                            class: "text-center",
                            "mRender": function (data, type, row) {
                                return row.size1 + row.size2 + row.size3 + row.size4  +
                                        row.size5 + row.size6 + row.size7 + row.size8  +
                                        row.size9 + row.size10 + row.size11 + row.size12 +
                                        row.size13 + row.size14 + row.size15 + row.size16 + row.size17 + row.size18 + row.size1T + row.size2T + row.size3T + row.size4T + row.size5T + row.size6T + row.size7T + row.size8T + row.size9T + row.size10T + row.size11T + row.size12T + row.size13T ;
                            },
                            "aTargets": [33]
                        },
                        {
