...
<html>
    <head>
        <Title>Scan Out | Sample Room</Title>
            ...
            $(document).ready(function () {
                ...
                scanner.addListener('scan', function (data) {
                    ...
                    if (temp.length <= 8) {
                        ...
                        dataJson.type = "Out";
                        dataJson.itemNumber = value6;
                        dataJson.workOrderNumber = value7;
            ...
            <div class="row">
                <div class="col-lg-4 ">
                    <div class="main-header">
                        ...
                        <h3><i class="fa fa-instagram fa-fw"></i> Scan Out </h3><em>Sample Room</em>
                    </div>
                </div>               
            </div>
            <!-- main -->
