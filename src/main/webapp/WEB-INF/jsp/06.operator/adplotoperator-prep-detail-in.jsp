<%-- 
    Document   : adplotoperator-prep-detail-in
    Created on : Apr 19, 2021, 10:38:20 AM
    Author     : Egi
--%>
...
//                    "paging": false,
                    ...
                    "aoColumnDefs": [
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize1 === 1 && row.flagPrepInSize1 === 1) {
                                ...
                                } else if (row.flagCtOutSize1 === 1 && row.flagPrepInSize1 === null) {
                                ...
                                } else if (row.flagCtOutSize1 === null) {
                                    return  '<td class="size1">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize1T === 1 && row.flagPrepInSize1T === 1) {
                                ...
                                } else if (row.flagCtOutSize1T === 1 && row.flagPrepInSize1T === null) {
                                ...
                                } else if (row.flagCtOutSize1T === null) {
                                    return  '<td class="size1T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize2 === 1 && row.flagPrepInSize2 === 1) {
                                ...
                                } else if (row.flagCtOutSize2 === 1 && row.flagPrepInSize2 === null) {
                                ...
                                } else if (row.flagCtOutSize2 === null) {
                                    return  '<td class="size2">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize2T === 1 && row.flagPrepInSize2T === 1) {
                                ...
                                } else if (row.flagCtOutSize2T === 1 && row.flagPrepInSize2T === null) {
                                ...
                                } else if (row.flagCtOutSize2T === null) {
                                    return  '<td class="size2T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize3 === 1 && row.flagPrepInSize3 === 1) {
                                ...
                                } else if (row.flagCtOutSize3 === 1 && row.flagPrepInSize3 === null) {
                                ...
                                } else if (row.flagCtOutSize3 === null) {
                                    return  '<td class="size3">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize3T === 1 && row.flagPrepInSize3T === 1) {
                                ...
                                } else if (row.flagCtOutSize3T === 1 && row.flagPrepInSize3T === null) {
                                ...
                                } else if (row.flagCtOutSize3T === null) {
                                    return  '<td class="size3T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize4 === 1 && row.flagPrepInSize4 === 1) {
                                ...
                                } else if (row.flagCtOutSize4 === 1 && row.flagPrepInSize4 === null) {
                                ...
                                } else if (row.flagCtOutSize4 === null) {
                                    return  '<td class="size4">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize4T === 1 && row.flagPrepInSize4T === 1) {
                                ...
                                } else if (row.flagCtOutSize4T === 1 && row.flagPrepInSize4T === null) {
                                ...
                                } else if (row.flagCtOutSize4T === null) {
                                    return  '<td class="size4T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize5 === 1 && row.flagPrepInSize5 === 1) {
                                ...
                                } else if (row.flagCtOutSize5 === 1 && row.flagPrepInSize5 === null) {
                                ...
                                } else if (row.flagCtOutSize5 === null) {
                                    return  '<td class="size5">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize5T === 1 && row.flagPrepInSize5T === 1) {
                                ...
                                } else if (row.flagCtOutSize5T === 1 && row.flagPrepInSize5T === null) {
                                ...
                                } else if (row.flagCtOutSize5T === null) {
                                    return  '<td class="size5T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize6 === 1 && row.flagPrepInSize6 === 1) {
                                ...
                                } else if (row.flagCtOutSize6 === 1 && row.flagPrepInSize6 === null) {
                                ...
                                } else if (row.flagCtOutSize6 === null) {
                                    return  '<td class="size6">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize6T === 1 && row.flagPrepInSize6T === 1) {
                                ...
                                } else if (row.flagCtOutSize6T === 1 && row.flagPrepInSize6T === null) {
                                ...
                                } else if (row.flagCtOutSize6T === null) {
                                    return  '<td class="size6T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize7 === 1 && row.flagPrepInSize7 === 1) {
                                ...
                                } else if (row.flagCtOutSize7 === 1 && row.flagPrepInSize7 === null) {
                                ...
                                } else if (row.flagCtOutSize7 === null) {
                                    return  '<td class="size7">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize7T === 1 && row.flagPrepInSize7T === 1) {
                                ...
                                } else if (row.flagCtOutSize7T === 1 && row.flagPrepInSize7T === null) {
                                ...
                                } else if (row.flagCtOutSize7T === null) {
                                    return  '<td class="size7T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize8 === 1 && row.flagPrepInSize8 === 1) {
                                ...
                                } else if (row.flagCtOutSize8 === 1 && row.flagPrepInSize8 === null) {
                                ...
                                } else if (row.flagCtOutSize8 === null) {
                                    return  '<td class="size8">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize8T === 1 && row.flagPrepInSize8T === 1) {
                                ...
                                } else if (row.flagCtOutSize8T === 1 && row.flagPrepInSize8T === null) {
                                ...
                                } else if (row.flagCtOutSize8T === null) {
                                    return  '<td class="size8T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize9 === 1 && row.flagPrepInSize9 === 1) {
                                ...
                                } else if (row.flagCtOutSize9 === 1 && row.flagPrepInSize9 === null) {
                                ...
                                } else if (row.flagCtOutSize9 === null) {
                                    return  '<td class="size9">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize9T === 1 && row.flagPrepInSize9T === 1) {
                                ...
                                } else if (row.flagCtOutSize9T === 1 && row.flagPrepInSize9T === null) {
                                ...
                                } else if (row.flagCtOutSize9T === null) {
                                    return  '<td class="size9T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize10 === 1 && row.flagPrepInSize10 === 1) {
                                ...
                                } else if (row.flagCtOutSize10 === 1 && row.flagPrepInSize10 === null) {
                                ...
                                } else if (row.flagCtOutSize10 === null) {
                                    return  '<td class="size10">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize10T === 1 && row.flagPrepInSize10T === 1) {
                                ...
                                } else if (row.flagCtOutSize10T === 1 && row.flagPrepInSize10T === null) {
                                ...
                                } else if (row.flagCtOutSize10T === null) {
                                    return  '<td class="size10T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize11 === 1 && row.flagPrepInSize11 === 1) {
                                ...
                                } else if (row.flagCtOutSize11 === 1 && row.flagPrepInSize11 === null) {
                                ...
                                } else if (row.flagCtOutSize11 === null) {
                                    return  '<td class="size11">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize11T === 1 && row.flagPrepInSize11T === 1) {
                                ...
                                } else if (row.flagCtOutSize11T === 1 && row.flagPrepInSize11T === null) {
                                ...
                                } else if (row.flagCtOutSize11T === null) {
                                    return  '<td class="size11T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize12 === 1 && row.flagPrepInSize12 === 1) {
                                ...
                                } else if (row.flagCtOutSize12 === 1 && row.flagPrepInSize12 === null) {
                                ...
                                } else if (row.flagCtOutSize12 === null) {
                                    return  '<td class="size12">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize12T === 1 && row.flagPrepInSize12T === 1) {
                                ...
                                } else if (row.flagCtOutSize12T === 1 && row.flagPrepInSize12T === null) {
                                ...
                                } else if (row.flagCtOutSize12T === null) {
                                    return  '<td class="size12T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize13 === 1 && row.flagPrepInSize13 === 1) {
                                ...
                                } else if (row.flagCtOutSize13 === 1 && row.flagPrepInSize13 === null) {
                                ...
                                } else if (row.flagCtOutSize13 === null) {
                                    return  '<td class="size13">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize13T === 1 && row.flagPrepInSize13T === 1) {
                                ...
                                } else if (row.flagCtOutSize13T === 1 && row.flagPrepInSize13T === null) {
                                ...
                                } else if (row.flagCtOutSize13T === null) {
                                    return  '<td class="size13T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize14 === 1 && row.flagPrepInSize14 === 1) {
                                ...
                                } else if (row.flagCtOutSize14 === 1 && row.flagPrepInSize14 === null) {
                                ...
                                } else if (row.flagCtOutSize14 === null) {
                                    return  '<td class="size14">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize15 === 1 && row.flagPrepInSize15 === 1) {
                                ...
                                } else if (row.flagCtOutSize15 === 1 && row.flagPrepInSize15 === null) {
                                ...
                                } else if (row.flagCtOutSize15 === null) {
                                    return  '<td class="size15">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize16 === 1 && row.flagPrepInSize16 === 1) {
                                ...
                                } else if (row.flagCtOutSize16 === 1 && row.flagPrepInSize16 === null) {
                                ...
                                } else if (row.flagCtOutSize16 === null) {
                                    return  '<td class="size16">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize17 === 1 && row.flagPrepInSize17 === 1) {
                                ...
                                } else if (row.flagCtOutSize17 === 1 && row.flagPrepInSize17 === null) {
                                ...
                                } else if (row.flagCtOutSize17 === null) {
                                    return  '<td class="size17">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                ...
                                } else if (row.flagPrepOutSize18 === 1 && row.flagPrepInSize18 === 1) {
                                ...
                                } else if (row.flagCtOutSize18 === 1 && row.flagPrepInSize18 === null) {
                                ...
                                } else if (row.flagCtOutSize18 === null) {
                                    return  '<td class="size18">' + "" + '</td>';
                                } else {
                ...
                var oTable2 = $("#dataTableKanban").dataTable({
                    ...
                    "aoColumnDefs": [
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size1 === null) {
                                    return  '<td class="size1">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize1 === 1 && row.flagExPrepInSize1 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size1 + ' </span></a>';
                                } else if (row.flagExCtOutSize1 === 1 && row.flagExPrepInSize1 === null) {
                                ...
                                } else if (row.flagExCtOutSize1 === null) {
                                    return  '<td class="size1">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size2 === null) {
                                    return  '<td class="size2">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize2 === 1 && row.flagExPrepInSize2 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size2 + ' </span></a>';
                                } else if (row.flagExCtOutSize2 === 1 && row.flagExPrepInSize2 === null) {
                                ...
                                } else if (row.flagExCtOutSize2 === null) {
                                    return  '<td class="size2">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size3 === null) {
                                    return  '<td class="size3">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize3 === 1 && row.flagExPrepInSize3 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size3 + ' </span></a>';
                                } else if (row.flagExCtOutSize3 === 1 && row.flagExPrepInSize3 === null) {
                                ...
                                } else if (row.flagExCtOutSize3 === null) {
                                    return  '<td class="size3">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size4 === null) {
                                    return  '<td class="size4">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize4 === 1 && row.flagExPrepInSize4 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size4 + ' </span></a>';
                                } else if (row.flagExCtOutSize4 === 1 && row.flagExPrepInSize4 === null) {
                                ...
                                } else if (row.flagExCtOutSize4 === null) {
                                    return  '<td class="size4">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size5 === null) {
                                    return  '<td class="size5">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize5 === 1 && row.flagExPrepInSize5 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size5 + ' </span></a>';
                                } else if (row.flagExCtOutSize5 === 1 && row.flagExPrepInSize5 === null) {
                                ...
                                } else if (row.flagExCtOutSize5 === null) {
                                    return  '<td class="size5">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size6 === null) {
                                    return  '<td class="size6">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize6 === 1 && row.flagExPrepInSize6 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size6 + ' </span></a>';
                                } else if (row.flagExCtOutSize6 === 1 && row.flagExPrepInSize6 === null) {
                                ...
                                } else if (row.flagExCtOutSize6 === null) {
                                    return  '<td class="size6">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size7 === null) {
                                    return  '<td class="size7">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize7 === 1 && row.flagExPrepInSize7 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size7 + ' </span></a>';
                                } else if (row.flagExCtOutSize7 === 1 && row.flagExPrepInSize7 === null) {
                                ...
                                } else if (row.flagExCtOutSize7 === null) {
                                    return  '<td class="size7">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size8 === null) {
                                    return  '<td class="size8">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize8 === 1 && row.flagExPrepInSize8 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size8 + ' </span></a>';
                                } else if (row.flagExCtOutSize8 === 1 && row.flagExPrepInSize8 === null) {
                                ...
                                } else if (row.flagExCtOutSize8 === null) {
                                    return  '<td class="size8">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size10 === null) {
                                    ...
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size10 + ' </span></a>';
                                } else if (row.flagExCtOutSize10 === 1 && row.flagExPrepInSize10 === null) {
                                ...
                                } else if (row.flagExCtOutSize10 === null) {
                                    return  '<td class="size10">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size11 === null) {
                                    return  '<td class="size11">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize11 === 1 && row.flagExPrepInSize11 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size11 + ' </span></a>';
                                } else if (row.flagExCtOutSize11 === 1 && row.flagExPrepInSize11 === null) {
                                ...
                                } else if (row.flagExCtOutSize11 === null) {
                                    return  '<td class="size11">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size12 === null) {
                                    return  '<td class="size12">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize12 === 1 && row.flagExPrepInSize12 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size12 + ' </span></a>';
                                } else if (row.flagExCtOutSize12 === 1 && row.flagExPrepInSize12 === null) {
                                ...
                                } else if (row.flagExCtOutSize12 === null) {
                                    return  '<td class="size12">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size13 === null) {
                                    return  '<td class="size13">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize13 === 1 && row.flagExPrepInSize13 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size13 + ' </span></a>';
                                } else if (row.flagExCtOutSize13 === 1 && row.flagExPrepInSize13 === null) {
                                ...
                                } else if (row.flagExCtOutSize13 === null) {
                                    return  '<td class="size13">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size14 === null) {
                                    return  '<td class="size14">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize14 === 1 && row.flagExPrepInSize14 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size14 + ' </span></a>';
                                } else if (row.flagExCtOutSize14 === 1 && row.flagExPrepInSize14 === null) {
                                ...
                                } else if (row.flagExCtOutSize14 === null) {
                                    return  '<td class="size14">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size15 === null) {
                                    return  '<td class="size15">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize15 === 1 && row.flagExPrepInSize15 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size15 + ' </span></a>';
                                } else if (row.flagExCtOutSize15 === 1 && row.flagExPrepInSize15 === null) {
                                ...
                                } else if (row.flagExCtOutSize15 === null) {
                                    return  '<td class="size15">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size16 === null) {
                                    return  '<td class="size16">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize16 === 1 && row.flagExPrepInSize16 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size16 + ' </span></a>';
                                } else if (row.flagExCtOutSize16 === 1 && row.flagExPrepInSize16 === null) {
                                ...
                                } else if (row.flagExCtOutSize16 === null) {
                                    return  '<td class="size16">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size17 === null) {
                                    return  '<td class="size17">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize17 === 1 && row.flagExPrepInSize17 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size17 + ' </span></a>';
                                } else if (row.flagExCtOutSize17 === 1 && row.flagExPrepInSize17 === null) {
                                ...
                                } else if (row.flagExCtOutSize17 === null) {
                                    return  '<td class="size17">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size18 === null) {
                                    return  '<td class="size18">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize18 === 1 && row.flagExPrepInSize18 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size18 + ' </span></a>';
                                } else if (row.flagExCtOutSize18 === 1 && row.flagExPrepInSize18 === null) {
                                ...
                                } else if (row.flagExCtOutSize18 === null) {
                                    return  '<td class="size18">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size1T === null) {
                                    return  '<td class="size1T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize1T === 1 && row.flagExPrepInSize1T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size1T + ' </span></a>';
                                } else if (row.flagExCtOutSize1T === 1 && row.flagExPrepInSize1T === null) {
                                ...
                                } else if (row.flagExCtOutSize1T === null) {
                                    return  '<td class="size1T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size2T === null) {
                                    return  '<td class="size2T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize2T === 1 && row.flagExPrepInSize2T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size2T + ' </span></a>';
                                } else if (row.flagExCtOutSize2T === 1 && row.flagExPrepInSize2T === null) {
                                ...
                                } else if (row.flagExCtOutSize2T === null) {
                                    return  '<td class="size2T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size3T === null) {
                                    return  '<td class="size3T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize3T === 1 && row.flagExPrepInSize3T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size3T + ' </span></a>';
                                } else if (row.flagExCtOutSize3T === 1 && row.flagExPrepInSize3T === null) {
                                ...
                                } else if (row.flagExCtOutSize3T === null) {
                                    return  '<td class="size3T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size4T === null) {
                                    return  '<td class="size4T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize4T === 1 && row.flagExPrepInSize4T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size4T + ' </span></a>';
                                } else if (row.flagExCtOutSize4T === 1 && row.flagExPrepInSize4T === null) {
                                ...
                                } else if (row.flagExCtOutSize4T === null) {
                                    return  '<td class="size4T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size5T === null) {
                                    return  '<td class="size5T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize5T === 1 && row.flagExPrepInSize5T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size5T + ' </span></a>';
                                } else if (row.flagExCtOutSize5T === 1 && row.flagExPrepInSize5T === null) {
                                ...
                                } else if (row.flagExCtOutSize5T === null) {
                                    return  '<td class="size5T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size6T === null) {
                                    return  '<td class="size6T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize6T === 1 && row.flagExPrepInSize6T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size6T + ' </span></a>';
                                } else if (row.flagExCtOutSize6T === 1 && row.flagExPrepInSize6T === null) {
                                ...
                                } else if (row.flagExCtOutSize6T === null) {
                                    return  '<td class="size6T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size7T === null) {
                                    return  '<td class="size7T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize7T === 1 && row.flagExPrepInSize7T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size7T + ' </span></a>';
                                } else if (row.flagExCtOutSize7T === 1 && row.flagExPrepInSize7T === null) {
                                ...
                                } else if (row.flagExCtOutSize7T === null) {
                                    return  '<td class="size7T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size8T === null) {
                                    return  '<td class="size8T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize8T === 1 && row.flagExPrepInSize8T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size8T + ' </span></a>';
                                } else if (row.flagExCtOutSize8T === 1 && row.flagExPrepInSize8T === null) {
                                ...
                                } else if (row.flagExCtOutSize8T === null) {
                                    return  '<td class="size8T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size9T === null) {
                                    return  '<td class="size9T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize9T === 1 && row.flagExPrepInSize9T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size9T + ' </span></a>';
                                } else if (row.flagExCtOutSize9T === 1 && row.flagExPrepInSize9T === null) {
                                ...
                                } else if (row.flagExCtOutSize9T === null) {
                                    return  '<td class="size9T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size10T === null) {
                                    return  '<td class="size10T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize10T === 1 && row.flagExPrepInSize10T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size10T + ' </span></a>';
                                } else if (row.flagExCtOutSize10T === 1 && row.flagExPrepInSize10T === null) {
                                ...
                                } else if (row.flagExCtOutSize10T === null) {
                                    return  '<td class="size10T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size11T === null) {
                                    return  '<td class="size11T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize11T === 1 && row.flagExPrepInSize11T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size11T + ' </span></a>';
                                } else if (row.flagExCtOutSize11T === 1 && row.flagExPrepInSize11T === null) {
                                ...
                                } else if (row.flagExCtOutSize11T === null) {
                                    return  '<td class="size11T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size12T === null) {
                                    return  '<td class="size12T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize12T === 1 && row.flagExPrepInSize12T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size12T + ' </span></a>';
                                } else if (row.flagExCtOutSize12T === 1 && row.flagExPrepInSize12T === null) {
                                ...
                                } else if (row.flagExCtOutSize12T === null) {
                                    return  '<td class="size12T">' + "" + '</td>';
                                } else {
                        ...
                        },
                        {
                            ...
                            "mRender": function (data, type, row) {
                                if (row.size13T === null) {
                                    return  '<td class="size13T">' + "" + '</td>';
                                } else if (row.flagExPrepOutSize13T === 1 && row.flagExPrepInSize13T === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(0, 255, 19);" class="label label-status label-warning">' + row.size13T + ' </span></a>';
                                } else if (row.flagExCtOutSize13T === 1 && row.flagExPrepInSize13T === null) {
                                ...
                                } else if (row.flagExCtOutSize13T === null) {
                                    return  '<td class="size13T">' + "" + '</td>';
                                } else {
                    ...
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        // computing column Total of the complete result 
                        var size1 =  api.cells( function ( index, data, node ) {
                                    var flagEx1 = aaData[index].flagExCtOutSize1; 
                                    sumSize1 += flagEx1 === 1 ? aaData[index].size1 : 0;
                                    }, 0);

                        var size1T = api.cells( function ( index, data, node ) {
                                    var flagEx1T = aaData[index].flagExCtOutSize1T; 
                                    sumSize1T += flagEx1T === 1 ? aaData[index].size1T : 0;
                                    }, 0);

                        var size2 = api.cells( function ( index, data, node ) {
                                    var flagEx2 = aaData[index].flagExCtOutSize2; 
                                    sumSize2 += flagEx2 === 1 ? aaData[index].size2 : 0;
                                    }, 0);

                        var size2T = api.cells( function ( index, data, node ) {
                                    var flagEx2T = aaData[index].flagExCtOutSize2T; 
                                    sumSize2T += flagEx2T === 1 ? aaData[index].size2T : 0;
                                    }, 0);

                        var size3 = api.cells( function ( index, data, node ) {
                                    var flagEx3 = aaData[index].flagExCtOutSize3; 
                                    sumSize3 += flagEx3 === 1 ? aaData[index].size3 : 0;
                                    }, 0);

                        var size3T = api.cells( function ( index, data, node ) {
                                    var flagEx3T = aaData[index].flagExCtOutSize3T; 
                                    sumSize3T += flagEx3T === 1 ? aaData[index].size3T : 0;
                                    }, 0);

                        var size4 = api.cells( function ( index, data, node ) {
                                    var flagEx4 = aaData[index].flagExCtOutSize4; 
                                    sumSize4 += flagEx4 === 1 ? aaData[index].size4 : 0;
                                    }, 0);

                        var size4T = api.cells( function ( index, data, node ) {
                                    var flagEx4T = aaData[index].flagExCtOutSize4T; 
                                    sumSize4T += flagEx4T === 1 ? aaData[index].size4T : 0;
                                    }, 0);
                       
                        var size5 = api.cells( function ( index, data, node ) {
                                    var flagEx5 = aaData[index].flagExCtOutSize5; 
                                    sumSize5 += flagEx5 === 1 ? aaData[index].size5 : 0;
                                    }, 0);
                                    
                        var size5T =  api.cells( function ( index, data, node ) {
                                    var flagEx5T = aaData[index].flagExCtOutSize5T;
                                    sumSize5T += flagEx5T === 1 ? aaData[index].size5T : 0;
                                    }, 0);

                        var size6 = api.cells( function ( index, data, node ) {
                                    var flagEx6 = aaData[index].flagExCtOutSize6;
                                    sumSize6 += flagEx6 === 1 ? aaData[index].size6 : 0;
                                    }, 0);

                        var size6T = api.cells( function ( index, data, node ) {
                                    var flagEx6T = aaData[index].flagExCtOutSize6T;
                                    sumSize6T += flagEx6T === 1 ? aaData[index].size6T : 0;
                                    }, 0);

                        var size7 = api.cells( function ( index, data, node ) {
                                    var flagEx7 = aaData[index].flagExCtOutSize7;
                                    sumSize7 += flagEx7 === 1 ? aaData[index].size7 : 0;
                                    }, 0);


                        var size7T = api.cells( function ( index, data, node ) {
                                    var flagEx7T = aaData[index].flagExCtOutSize7T;
                                    sumSize7T += flagEx7T === 1 ? aaData[index].size7T : 0;
                                    }, 0);


                        var size8 = api.cells( function ( index, data, node ) {
                                    var flagEx8 = aaData[index].flagExCtOutSize8;
                                    sumSize8 += flagEx8 === 1 ? aaData[index].size8 : 0;
                                    }, 0);

                        var size8T = api.cells( function ( index, data, node ) {
                                    var flagEx8T = aaData[index].flagExCtOutSize8T;
                                    sumSize8T += flagEx8T === 1 ? aaData[index].size8T : 0;
                                    }, 0);


                        var size9 = api.cells( function ( index, data, node ) {
                                    var flagEx9 = aaData[index].flagExCtOutSize9;
                                    sumSize9 += flagEx9 === 1 ? aaData[index].size9 : 0;
                                    }, 0);

                        var size9T = api.cells( function ( index, data, node ) {
                                    var flagEx9T = aaData[index].flagExCtOutSize9T;
                                    sumSize9T += flagEx9T === 1 ? aaData[index].size9T : 0;
                                    }, 0);

                        var size10 = api.cells( function ( index, data, node ) {
                                    var flagEx10 = aaData[index].flagExCtOutSize10;
                                    sumSize10+= flagEx10 === 1 ? aaData[index].size10 : 0;
                                    }, 0);

                        var size10T = api.cells( function ( index, data, node ) {
                                    var flagEx10T = aaData[index].flagExCtOutSize10T;
                                    sumSize10T += flagEx10T === 1 ? aaData[index].size10T : 0;
                                    }, 0);

                        var size11 = api.cells( function ( index, data, node ) {
                                    var flagEx11 = aaData[index].flagExCtOutSize11;
                                    sumSize11+= flagEx11 === 1 ? aaData[index].size11 : 0;
                                    }, 0);

                        var size11T = api.cells( function ( index, data, node ) {
                                    var flagEx11T = aaData[index].flagExCtOutSize11T;
                                    sumSize11T += flagEx11T === 1 ? aaData[index].size11T : 0;
                                    }, 0);

                        var size12 = api.cells( function ( index, data, node ) {
                                    var flagEx12 = aaData[index].flagExCtOutSize12;
                                    sumSize12 += flagEx12 === 1 ? aaData[index].size12 : 0;
                                    }, 0);

                        var size12T = api.cells( function ( index, data, node ) {
                                    var flagEx12T = aaData[index].flagExCtOutSize12T;
                                    sumSize12T += flagEx12T === 1 ? aaData[index].size12T : 0;
                                    }, 0);

                        var size13 = api.cells( function ( index, data, node ) {
                                    var flagEx13 = aaData[index].flagExCtOutSize13;
                                    sumSize13 += flagEx13 === 1 ? aaData[index].size13 : 0;
                                    }, 0);

                        var size13T = api.cells( function ( index, data, node ) {
                                    var flagEx13T= aaData[index].flagExCtOutSize13T;
                                    sumSize13T += flagEx13T === 1 ? aaData[index].size13T : 0;
                                    }, 0);

                        var size14 = api.cells( function ( index, data, node ) {
                                    var flagEx14 = aaData[index].flagExCtOutSize14;
                                    sumSize14 += flagEx14 === 1 ? aaData[index].size14 : 0;
                                    }, 0);

                        var size15 = api.cells( function ( index, data, node ) {
                                    var flagEx15 = aaData[index].flagExCtOutSize15;
                                    sumSize15 += flagEx15 === 1 ? aaData[index].size15 : 0;
                                    }, 0);

                        var size16 = api.cells( function ( index, data, node ) {
                                    var flagEx16 = aaData[index].flagExCtOutSize16;
                                    sumSize16 += flagEx16 === 1 ? aaData[index].size16 : 0;
                                    }, 0);

                        var size17 = api.cells( function ( index, data, node ) {
                                    var flagEx17 = aaData[index].flagExCtOutSize17;
                                    sumSize17 += flagEx17 === 1 ? aaData[index].size17 : 0;
                                    }, 0);

                        var size18 = api.cells( function ( index, data, node ) {
                                    var flagEx18 = aaData[index].flagExCtOutSize18;
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="main-header">
                        ...
                        <h3><i class="fa fa-file-o fa-fw"></i> LOT Basis </h3><em>Operator | </em><em id="proses"> IN </em><em> | ${produksi.lineCode} | </em><em id="area"> Preparation </em>
                    </div>
                </div>
                <div class="col-lg-8 ">
