...
//                                return list + data;
                            ...
                            if (row.size1 === null && row.size2 === null && row.size3 === null && row.size4 === null && row.size5 === null && row.size6 === null && row.size7 === null && row.size8 === null && row.size9 === null && row.size10 === null && row.size11 === null && row.size12 === null && row.size13 === null && row.size14 === null && row.size15 === null && row.size16 === null && row.size17 === null && row.size18 === null && row.size1T === null
                                    && row.size2T === null && row.size3T === null && row.size4T === null && row.size5T === null && row.size6T === null && row.size7T === null && row.size8T === null && row.size9T === null && row.size10T === null && row.size11T === null && row.size12T === null && row.size13T === null) {
                                    return  '<td class="Id">' + "" + '</td>';
                                } else if (row.flagPrepInSize1 === 1 || row.flagPrepInSize2 === 1) {
                                    return '<a type="button" style="cursor: pointer;"><span style ="background-color: rgb(11,13,98);" class="label label-status label-warning"><i class="fa fa-check-square"></i></span></a>';
                                        ...
                                        || (row.flagCtInSize1T === 1 && row.flagCtOutSize1T === 1) || (row.flagCtInSize2T === 1 && row.flagCtOutSize2T === 1) || (row.flagCtInSize3T === 1 && row.flagCtOutSize3T === 1) || (row.flagCtInSize4T === 1 && row.flagCtOutSize4T === 1) || (row.flagCtInSize5T === 1 && row.flagCtOutSize5T === 1) || (row.flagCtInSize6T === 1 && row.flagCtOutSize6T === 1) || (row.flagCtInSize7T === 1 && row.flagCtOutSize7T === 1) || (row.flagCtInSize8T === 1 && row.flagCtOutSize8T === 1) || (row.flagCtInSize9T === 1 && row.flagCtOutSize9T === 1) 
                                        || (row.flagCtInSize10T === 1 && row.flagCtOutSize10T === 1) || (row.flagCtInSize11T === 1 && row.flagCtOutSize11T === 1) || (row.flagCtInSize12T === 1 && row.flagCtOutSize12T === 1) || (row.flagCtInSize13T === 1 && row.flagCtOutSize13T === 1)) {
                                ...
                                } else if (row.flagCtInSize1 === 1 || row.flagCtInSize2 === 1 || row.flagCtInSize3 === 1 || row.flagCtInSize4 === 1 || row.flagCtInSize5 === 1 || row.flagCtInSize6 === 1 || row.flagCtInSize7 === 1 || row.flagCtInSize8 === 1 || row.flagCtInSize9 === 1 || row.flagCtInSize10 === 1 || row.flagCtInSize11 === 1 || row.flagCtInSize12 === 1 || row.flagCtInSize13 === 1 
                                        || row.flagCtInSize14 === 1 || row.flagCtInSize15 === 1 || row.flagCtInSize16 === 1 || row.flagCtInSize17 === 1 || row.flagCtInSize18 === 1 || row.flagCtInSize1T === 1 || row.flagCtInSize2T === 1 || row.flagCtInSize3T === 1 || row.flagCtInSize4T === 1 || row.flagCtInSize5T === 1 || row.flagCtInSize6T === 1 || row.flagCtInSize7T === 1 || row.flagCtInSize8T === 1 
                                        || row.flagCtInSize9T === 1 || row.flagCtInSize10T === 1 || row.flagCtInSize11T === 1 || row.flagCtInSize12T === 1 || row.flagCtInSize13T === 1) {
                                    if (row.Id !== 1){if (row.flagCtInSize1 === null){return  '<td class="id">' + "" + '</td>';}
