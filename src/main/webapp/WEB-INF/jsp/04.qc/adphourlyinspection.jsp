                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                   <center>
                                    <a href="http://10.1.1.88:3000/public/dashboard/25ba5abf-2098-45b8-829e-97b012604260" target="_blank" class="btn btn-sm btn-primary" style="border-radius:10px;border:1px solid black;margin-right: 10px;"><i class="fa fa-dashboard" style="color: white;"></i></a>
