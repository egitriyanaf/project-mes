                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Po No" id="listpoNo"  class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled="true" type="text" placeholder="NCVS" id="listNcvs" name="listNcvs" class="form-control">
                                    </div>
                                </div>
                            </div>
