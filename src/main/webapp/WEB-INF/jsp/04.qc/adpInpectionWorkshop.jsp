        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                function counterCategory() {
                    ...
                    var sampleVal = 0;
                    var counterFunc = _fw_post('/qc/hourlyinspection/counter-workshop', data, function (res) {
                        console.log(res)
                        var datas = [];
                        if (res.length != 0) {
                ...
                $('button[name=buttonRework]').click(function () {
                    ...
                    submit('/qc/hourlyinspection/save', JSON.stringify(dataJson), function (data) {
                        console.log(data);
                ...
                //         };
                //         var stringElement = '';
                //         _fw_post('/qc/hourlyinspection/product', data, function(res) {
                //             if (res.length !== 0) {
                //                 res.forEach(function(data) {
                //                     stringElement += '<label id ="productLabel" class="btnQcProduct">' + data.productDesc + '<input id="idProduct" name="idProduct" type="radio" value="' + data.poNo + '" hidden/></label>';
                //                 });
                //             }
                ...
                (function () {
                    ...
                    var stringElement = '';
                    _fw_post('/qc/hourlyinspection/defect', data, function (res) {
                        if (res.length !== 0) {
                ...
                $("#listNcvs").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "${pageContext.request.contextPath}/qc/inspectionworkshop/get-samplereq",
                    ...
                    select: function (event, ui) {
                        ...
                        (function () {
                            ...
                            var stringElement = '';
                            _fw_post('/qc/inspectionworkshop/get-samplereq', data, function (res) {
                                console.log(res);
                                if (res.length !== 0) {
                                    res.forEach(function (data) {
                ...
                <div class="widget-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-center">
                            ...
                            <div>
                                <button id="buttonDefact" name="buttonRework" class="btnQcDefact " value="Rework" style="width: 70px; padding: 0px 0px;">Rework</button>
                            </div>
